...
{   // 0 is for Steady state,1 is for transient,2 is for Sub transient
    double  H, Xd0,Xd1,Xd2,Xq0,Xq1,Xq2,Tdo1,Tdo2,Tqo1,Tqo2 ;
...
{ 
    gsl_complex I_0,Eq_0,id_0,iq_0,vd_0,vq_0,Efd_0,Eq_dash_0,Ed_dash_0,Te_0,Tm_0;
    double Ed_das_das,Eq_das_das,delta_0;
};
typedef struct INITIAL_VALUES INITIAL;

struct VOLATAGE_VECTOR
{
    gsl_complex V[Rval];
};
typedef struct VOLATAGE_VECTOR V_VECTOR ;
...
struct CURRENT_VECTOR_STRUCT
{
    gsl_complex I_X[Rval];
};
typedef struct CURRENT_VECTOR_STRUCT I_VECTOR;

struct STATE_VARIABLE
{
    double Ed_das,Eq_das,Ed_das_das,Eq_das_das,delta,slip;
};
...
{
    double f_of_Ed_das,f_of_Eq_das,f_of_Ed_das_das,f_of_Eq_das_das,f_of_delta,f_of_slip; 
};
...
struct INITIAL_VALUES
{
    double complex I_0,Eq_0,id_0,iq_0,vd_0,vq_0,Efd_0,Eq_dash_0,Ed_dash_0,Te_0,Tm_0;
};
typedef struct INITIAL_VALUES INITIAL */
